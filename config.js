...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/eBtlE6x.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    AUTOMUTE_MSG: process.env.AUTOMUTE_MSG || '_Group automuted!_\by_Maira Anjam',
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || 'xxx;xx;sex;porn',
    ANTI_SPAM: process.env.ANTI_SPAM || '923310469548',
    ...
    AUTOUNMUTE_MSG: process.env.AUTOUNMUTE_MSG || '_Group auto unmuted!_\by_Maira Anjam',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Maira;Anjam;0;https://i.imgur.com/eBtlE6x.jpeg;https://chat.whatsapp.com/HcFqqsST7ZMG4J7q0HlN5p',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Maira;Anjam",
    BOT_NAME: process.env.BOT_NAME || 'Maira Anjam',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Maira;Anjam;https://i.imgur.com/eBtlE6x.jpeg' : process.env.AUDIO_DATA,
